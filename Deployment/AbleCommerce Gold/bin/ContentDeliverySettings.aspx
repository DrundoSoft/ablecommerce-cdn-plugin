<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master"  Title="Configure Site Content Delivery Settings"  EnableViewState="false" ClassName="Admin_Store_ContentDeliverySettings" Inherits="CommerceBuilder.UI.AbleCommerceAdminPage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="pageHeader">
        <div class="caption">
            ...
            <uc1:NavagationLinks ID="NavigationLinks" runat="server" Path="configure" />
        </div>
    </div>
    ...
    <table cellpadding="2" cellspacing="0" class="innerLayout">
		<tr>
		    <td>
                <asp:UpdatePanel ID="PageAjax" runat="server" UpdateMode="Always">
                    <ContentTemplate>
